...
json_dir = "course_req/"  # JSON 파일들이 있는 디렉토리 경로 (필요 시 변경경)
...
# 기존 컬렉션 삭제
try:
    client.delete_collection("collection_course_req")
    print("🗑️ 기존 컬렉션 삭제 완료.")
except:
    print("⚠️ 기존 컬렉션이 없거나 삭제 실패.")
'''
...
for col_info in collections:
    ...
    for meta in metadatas:
        for key in meta.keys():  # dict는 삽입 순서대로 keys() 반환
